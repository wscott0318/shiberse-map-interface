import { Currency, CurrencyAmount, ETHER, JSBI, Pair, Percent, Price, TokenAmount } from '@shibaswap/sdk'
...
export function useDerivedMintInfo(
    ...
    const noLiquidity: boolean =
        !pairState || !totalSupply || pairState === PairState.NOT_EXISTS || Boolean(totalSupply && JSBI.equal(totalSupply.raw, ZERO))
